...
using recuperacionSemana9.Models;

namespace recuperacionSemana9.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmetID,Grade,CourseID,StudentID")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmetID,Grade,CourseID,StudentID")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
